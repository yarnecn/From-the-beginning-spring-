...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/common/css/main.css" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:;">
                        <img src="${pageContext.request.contextPath}/common/img/face.jpg" class="layui-circle" width="35" height="35">
                        <cite>请叫我马哥</cite>
                    </a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${pageContext.request.contextPath}/common/img/face.jpg"></a>
        ...
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                   <iframe src="${pageContext.request.contextPath}/common/page/main.html"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        tab = layui.bodyTab({
            ...
            url : pageContext+"/common/json/navs.json" //获取菜单json地址
        });
    });
...
<script type="text/javascript" src="${pageContext.request.contextPath}/common/js/leftNav.js"></script>
